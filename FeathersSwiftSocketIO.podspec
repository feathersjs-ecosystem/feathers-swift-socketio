Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   FeathersJS backend.
                   DESC
  s.homepage     = "https://github.com/startupthekid/feathers-swift-socketio"
  ...
  s.source       = { :git => "https://github.com/startupthekid/feathers-swift-socketio.git", :tag => "#{s.version}" }
